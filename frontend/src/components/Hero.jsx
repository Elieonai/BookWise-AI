  ...
  return (
    <section className="relative min-h-[400px] overflow-hidden">
      <img
        ...
        alt="Capivara"
        className="absolute bottom-[4%] right-[4%] w-[220px] sm:w-[280px] md:w-[300px] lg:w-[340px] object-contain"
      />
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16 pr-0 lg:pr-[380px]">
        <div className="max-w-md lg:max-w-xl">
          ...
          <p className="text-base sm:text-lg text-lime-800 mb-6">
            Reviews sinceros, recomendações inteligentes e leitores de todo o
            Brasil.
          </p>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a
              ...
              className="bg-lime-700 hover:bg-lime-800 text-white px-6 py-3 rounded-lg transition inline-block"
            >
              Ver Mais Avaliados
            </a>
          </div>
